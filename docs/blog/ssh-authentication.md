...
> In an **open source bastion host** like Next Terminal, this separation is reflected in asset credential management and host fingerprint handling. See [Asset Management](/docs/usage/asset), [Asset Access](/docs/usage/access), and [Termark native client](/docs/usage/termark) for direct access to authorized SSH assets.
