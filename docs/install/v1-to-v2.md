...
This guide applies only to migration from the discontinued 1.x series to 2.x. It is not an upgrade guide for current Next Terminal releases. For a current native installation, see [Native Installation Upgrade](/docs/install/native-upgrade).
:::
