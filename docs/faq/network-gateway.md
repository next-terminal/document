...
Use a Security Gateway for VPCs, office networks, multiple sites and reverse connectivity. Use an SSH Gateway when an existing SSH jump host should forward traffic. See [Asset Overview](/docs/usage/asset#choose-a-network-path).
