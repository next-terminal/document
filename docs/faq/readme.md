...
This section is organized by symptoms. Use the [User Guide](/docs/usage/readme) for normal configuration and workflows; backup, upgrades and migrations live under system maintenance or installation.
...
4. Check [Resource Authorization](/docs/usage/authorization).
5. Test connectivity from Next Terminal or the selected gateway to the target.
6. Search [Audit Logs](/docs/usage/audit).
...
- [System Property Reference](/docs/usage/system-properties)
- [Native Installation Upgrade](/docs/install/native-upgrade)
- [PostgreSQL 16 to 18 Migration](/docs/install/postgresql-16-to-18)
- [Upgrade 1.x to 2.x (historical)](/docs/install/v1-to-v2)
