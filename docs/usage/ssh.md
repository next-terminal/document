...
- You have a password or SSH private key. Create a reusable [Credential](/docs/usage/credential) when multiple hosts share an account.
...
Test the asset as an administrator, then assign it through [Resource Authorization](/docs/usage/authorization).

Users can connect from the [Browser Access Workspace](/docs/usage/access), a standard client through the [SSH Proxy Server](/docs/usage/ssh-server), or [Termark](/docs/usage/termark).
