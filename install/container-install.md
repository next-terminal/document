...
If you choose to migrate to PostgreSQL 18, follow [Migrate from PostgreSQL 16 to PostgreSQL 18](/install/postgresql-16-to-18). Otherwise, keep your existing PostgreSQL 16 configuration.
:::
