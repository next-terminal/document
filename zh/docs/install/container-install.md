...
安装之前请先检查硬件及依赖符合[系统需求](/zh/docs/install/system-requirements)
...
如需迁移到 PostgreSQL 18，请按照[从 PostgreSQL 16 迁移到 PostgreSQL 18](/zh/docs/install/postgresql-16-to-18)完成数据库迁移；不需要迁移时，请继续保留现有 PostgreSQL 16 配置。
:::
