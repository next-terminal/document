...
本区域按照用户看到的故障现象组织内容。正常配置和使用流程请优先查阅[使用文档](/zh/docs/usage/readme)；备份、升级和迁移位于安装或系统维护文档。
...
4. 检查[资源授权和访问策略](/zh/docs/usage/authorization)是否有效。
5. 检查 Next Terminal 或所选网关到目标地址和端口的连通性。
6. 在[日志审计](/zh/docs/usage/audit)中查询访问、会话、命令或文件记录。
...
- [系统备份与恢复](/zh/docs/usage/backup)
- [命令行工具参考](/zh/docs/usage/cli)
- [系统属性配置参考](/zh/docs/usage/system-properties)
- [原生安装升级](/zh/docs/install/native-upgrade)
- [PostgreSQL 16 迁移到 18](/zh/docs/install/postgresql-16-to-18)
- [从 1.x 升级到 2.x（历史）](/zh/docs/install/v1-to-v2)
