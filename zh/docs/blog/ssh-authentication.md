...
> 在 Next Terminal 这类**开源堡垒机**中，SSH 资产的凭证管理与主机指纹校验正是为了解决这两类认证的分离问题，详见 [资产管理](/zh/docs/usage/asset) 与 [资产访问](/zh/docs/usage/access)，亦可用 [Termark 本地客户端](/zh/docs/usage/termark) 直连已授权的 SSH 资产。
