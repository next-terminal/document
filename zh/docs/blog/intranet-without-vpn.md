...
> 以 Next Terminal 为例，网关反向隧道 + 按资产授权 + 会话审计是开箱即用的，上述四点它都覆盖；配置细节见[安全网关](/zh/docs/usage/agent-gateway)、[资产管理](/zh/docs/usage/asset)与[资产访问](/zh/docs/usage/access)。其他同类堡垒机落地思路一致，只是具体界面各有差异。
