...
Test the asset, then assign it using [Resource Authorization](/usage/authorization).

| Method | Best for |
| --- | --- |
| Browser desktop | Clientless temporary access and the unified workspace |
| [RDP Proxy Server](/usage/rdp-server) | Native clients such as Windows Remote Desktop |
| [Termark](/usage/termark) | A desktop inventory for authorized SSH and RDP assets |
...
Buttons appear according to the access strategy. See [File Management](/usage/file-management).
...
- **Black screen or negotiation errors:** see [RDP/VNC Error Codes](/usage/error-codes) and [RDP black-screen troubleshooting](/blog/rdp-black-screen-failed).
